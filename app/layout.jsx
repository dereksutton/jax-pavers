...
export const metadata = {
  title: 'Paver Installation Jacksonville FL | Driveways, Patios & Outdoor Kitchens | Jax Pavers',
  description: "Jacksonville FL's trusted paver contractor. Expert installation of paver driveways, patios, pool decks, outdoor kitchens & pergolas. Licensed, insured, 10-year warranty. 5-star rated on Google. Free consultations — call (904) 445-1261.",
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        {/* Preload hero image for Core Web Vitals */}
        <link rel="preload" as="image" href="/pavers-hero-1920w.webp" type="image/webp" />
